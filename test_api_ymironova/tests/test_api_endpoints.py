...
def test_create_obj(data, create_post_obj, start_finish_testing, switch_test):
    ...
    create_post_obj.check_response_code_is_correct()
...
def test_get_obj(switch_test, create_get_obj, setup_and_teardown):
    ...
    create_get_obj.check_response_code_is_correct()
...
def test_put_obj(switch_test, create_put_obj, setup_and_teardown, put_data):
    ...
    create_put_obj.check_response_code_is_correct()
    create_put_obj.check_response_change_put_is_correct(put_data)
...
def test_patch_obj(switch_test, create_patch_obj, setup_and_teardown, patch_data):
    ...
    create_patch_obj.check_response_code_is_correct()
    create_patch_obj.check_response_change_patch_is_correct(patch_data)
